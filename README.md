...
- **Mobile Vision**: Streams video frames from the mobile app to the backend for real-time Emotion Detection.
...
- Python 3.10+
- Node.js 18+
- Webcam (Essential for biometrics)
...
cd ../frontend
npm install
# Ensure rain.mp3 exists in frontend/public/
```
...
1. Open `mobile/App.js` and update `const PC_IP = "YOUR_LAPTOP_IP";`
2. Run:
   ```bash
...
Make a Sad or Angry face at the camera. Both the Laptop and Mobile App backgrounds will fade to a warm, soothing color.
